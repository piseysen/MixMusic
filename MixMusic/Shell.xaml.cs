...
namespace MixMusic
{
    ...
    public sealed partial class Shell : Page
    {
        ...
        private List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                ...
                new NavMenuItem()
                {
                    Symbol = Symbol.MusicInfo,
                    Label = "Production",
                    DestPage = typeof(ProductionPage)
                },
                 ...
                 new NavMenuItem()
                {
                    Symbol = Symbol.Play,
                    Label = "Now Playing",
                    DestPage = typeof(PlayingNowPage)
                }
            });
        ...
        /// <param name="e"></param>
        private void ShellApp_KeyDown(object sender, KeyRoutedEventArgs e)
        {
